...
constexpr uint16_t kDefaultPort = 12121;

/** @brief Header bytes for identifying gamepad data. */
constexpr unsigned char kHeader[kHeaderSize] = {0x55, 0x66};

constexpr size_t kRetroidButtonSize = 10;
constexpr size_t kSkydroidButtonSize = 8;
